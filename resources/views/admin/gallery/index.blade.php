...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-file-text-o"></i> {!! trans('gallery::gallery.name') !!} <small> {!! trans('app.manage') !!} {!! trans('gallery::gallery.names') !!}</small>
        </h1>
        <ol class="breadcrumb">
...
$(document).ready(function(){
    app.load('#gallery-gallery-entry', '{!!guard_url('gallery/gallery/0')!!}');
    oTable = $('#gallery-gallery-list').dataTable( {
        ...
        "sDom": 'R<>rt<ilp><"clear">',
        "bServerSide": true,
        "sAjaxSource": '{!! guard_url('gallery/gallery') !!}',
    ...
    $('#gallery-gallery-list tbody').on( 'click', 'tr td:not(:first-child)', function (e) {
        e.preventDefault();

        oTable.$('tr.selected').removeClass('selected');
        $(this).addClass('selected');
        var d = $('#gallery-gallery-list').DataTable().row( this ).data();
        $('#gallery-gallery-entry').load('{!!guard_url('gallery/gallery')!!}' + '/' + d.id);
    });

    $('#gallery-gallery-list tbody').on( 'change', "input[name^='id[]']", function (e) {
        e.preventDefault();
    ...
    $("#gallery-gallery-check-all").on( 'change', function (e) {
        e.preventDefault();
        aIds = [];
    ...
    $(".reset_filter").click(function (e) {
        ...
        $('#gallery-gallery-list .reset_filter').css('display', 'none');

    });


    // Add event listener for opening and closing details
    $('#gallery-gallery-list tbody').on('click', 'td.details-control', function (e) {
        e.preventDefault();
