<div class="btn-group gallery-gallery">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published]" class="col-sm-2 control-label">
                                        {!! trans('gallery::gallery.label.published')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::select('search[published]')
                                        -> options([''=>'All']+trans('gallery::gallery.options.published'))
                                        ->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        -> options([''=>'All']+trans('gallery::gallery.options.status'))
                                        ->raw()!!}
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".gallery-gallery .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/gallery.gallery.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".gallery-gallery .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.gallery-gallery .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'gallery.gallery.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#gallery-gallery-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#gallery-gallery-list .btn-reset-filter').css('display', 'none');
